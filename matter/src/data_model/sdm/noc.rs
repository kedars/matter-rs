...
use crate::interaction_model::messages::{ib, GenericPath};
...
impl NocCluster {
    ...
    fn _handle_command_addnoc(&mut self, cmd_req: &mut CommandReq) -> Result<(), NocStatus> {
        ...
        let invoke_resp = ib::CmdResponse::Data(CMD_PATH_NOCRESPONSE, |t| {
            // Status
    ...
    fn handle_command_attrequest(&mut self, cmd_req: &mut CommandReq) -> Result<(), IMStatusCode> {
        ...
        let invoke_resp = ib::CmdResponse::Data(CMD_PATH_ATTRESPONSE, |t| {
    ...
    fn handle_command_certchainrequest(
        ...
        let invoke_resp = ib::CmdResponse::Data(CMD_PATH_CERTCHAINRESPONSE, |t| {
    ...
    fn handle_command_csrrequest(&mut self, cmd_req: &mut CommandReq) -> Result<(), IMStatusCode> {
        ...
        let invoke_resp = ib::CmdResponse::Data(CMD_PATH_CSRRESPONSE, |t| {
            let mut buf: [u8; RESP_MAX] = [0; RESP_MAX];
